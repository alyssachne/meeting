...
public class SortAndFilter {
    ...
    public HashMap<String, String> FilterHelper(Scanner scanner){
        ...
        while (filterLoop) {
            ...
            System.out.println("1. Filter by speaker of event. (Input 'Speaker')");
            System.out.println("2. Filter by starting time of event. (Input 'time')");
            System.out.println("3. Filter by date. (Input 'date')");
