...
public class EventDealer {
     ...
     */
    public static void signUp(int eventId, AttendeeAct aa, EventFactory em, String username){
     ...
     */
    public static void cancelSpot(int eventId, AttendeeAct aa, EventFactory em, String username){
        aa.removeFromEvent(username,eventId);
        em.cancelSpot(username,eventId);
    }

    public static void cancelEvent(int eventId, Date date, EventFactory em, SpeakerAct sa, AttendeeAct aa, RoomManager rm,
                                   CalendarManager cm) {
    ...
    public static void changeAccess(int eventId, EventFactory em, String access) {
